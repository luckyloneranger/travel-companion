      ...
      <div className="relative" ref={menuRef}>
        ...
        {showMenu && (
          <div className="absolute right-0 mt-2 w-48 rounded-lg border border-border bg-surface shadow-lg z-50">
            <button
              className="flex w-full items-center gap-3 px-4 py-2.5 text-sm hover:bg-surface-hover rounded-t-lg transition-colors"
            ...
            <button
              className="flex w-full items-center gap-3 px-4 py-2.5 text-sm hover:bg-surface-hover rounded-b-lg transition-colors"
